...
public class XIAOSHOU_KEHUXINXI implements Serializable {
    private Long kid;
    ...
    public XIAOSHOU_KEHUXINXI(Long kid, String kname, String kshuxin, String wangzhan, String gupiaodaima, String shangjidanwei, String suoyouzhe, String yuangongshu, String hangyebianhao, String kehuleixing, String kehuzhuangtai, String kehulaiyuan, String fuzerenbianhao, String gudingdianhua, String yidongdianhua, String kehuchuangzhen, String kaihuyinhang, String yinhangzhanghu, String xiacilianxishijian, String dianziyoujian, String sicbianma, String zhifufangshi, String shifouyouxiao, String xiangxidizhi, String beizhuxinxi, Long gid, Date lasttime) {
        this.kid = kid;
        this.kname = kname;
