...
public class JhGysxx implements Serializable {
    ...
    public JhGysxx(BigDecimal gysId, String gysName, String gysJc, String lxr, String gdPhone, String ydPhone, String lxcz, String lxdz, String lxyb, String mail, String khbank, String yhzh, String gszy, String isYx, String operator, String remark, BigDecimal gsId, Date ltime) {
        this.gysId = gysId;
