...
public class STORE_GINFO implements Serializable {
    ...
    public STORE_GINFO(BigDecimal gid, String gname, String gcategopy, String gdesp, String gunit, BigDecimal whid, BigDecimal storenum, BigDecimal pricebuy, BigDecimal pricesold, BigDecimal priceact, String remark, BigDecimal cid, Date lasttime) {
        this.gid = gid;
        this.gname = gname;
