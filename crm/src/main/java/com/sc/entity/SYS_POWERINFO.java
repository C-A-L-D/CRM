...
public class SYS_POWERINFO implements Serializable {
    ...
    public SYS_POWERINFO(BigDecimal pid, String pname, String ppower, String pcolumnId, String pdescribe, Date lasttime) {
        this.pid = pid;
        this.pname = pname;
        this.ppower = ppower;
