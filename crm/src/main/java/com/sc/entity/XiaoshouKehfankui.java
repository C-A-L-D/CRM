...
public class XiaoshouKehfankui implements Serializable {
    private Long fid;
    ...
    public XiaoshouKehfankui(Long fid, String jiluyouxianji, Long kid, String zhuangtai, String fankuileixing, String fankuishijian, String fankuiyuanyin, String fuzeren, String fankuilaiyuan, String fankuizhuti, String fankuimiaoshu, String fenxi, Long gid, Date lasttime) {
        this.fid = fid;
	...
	public String toString() {
		return "XiaoshouKehfankui [fid=" + fid + ", jiluyouxianji=" + jiluyouxianji + ", kid=" + kid + ", zhuangtai="
				+ zhuangtai + ", fankuileixing=" + fankuileixing + ", fankuishijian=" + fankuishijian
				+ ", fankuiyuanyin=" + fankuiyuanyin + ", fuzeren=" + fuzeren + ", fankuilaiyuan=" + fankuilaiyuan
				+ ", fankuizhuti=" + fankuizhuti + ", fankuimiaoshu=" + fankuimiaoshu + ", fenxi=" + fenxi + ", gid="
				+ gid + ", lasttime=" + lasttime + "]";
	}
