...
public class SYS_JOBINFO implements Serializable {
    ...
    public SYS_JOBINFO(BigDecimal jid, String jname, BigDecimal did, String jdescribe, BigDecimal gongsiid, Date lasttime) {
        this.jid = jid;
        this.jname = jname;
        this.did = did;
