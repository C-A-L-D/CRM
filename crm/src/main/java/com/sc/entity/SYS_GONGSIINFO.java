...
public class SYS_GONGSIINFO implements Serializable {
    ...
    public SYS_GONGSIINFO(BigDecimal id, String gname, String gcode, String gemail, String glinkman, String gaddress, String gtel, String gphone, String gchuanzhen, String gopenyinghang, String gyinghangaccount, String gtf, String gdescribe, Date lasttime) {
        this.id = id;
        this.gname = gname;
        this.gcode = gcode;
        this.gemail = gemail;
