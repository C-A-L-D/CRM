        ...
        <form class="layui-form">
          ...
          <div class="layui-form-item">
              ...
              <input type="hidden" name="jid" value="${u.jid}">
                  ...
                  autocomplete="off" class="layui-input" value="${u.jname }">
              </div>
             ...
             <%--      <input type="text" id="did" name="did" required lay-verify="required"
                ...
                <select id="did" name="did" class="layui-input"> 
                   <c:forEach items="${p2 }" var="v2">
                    <option value="${v2.did }" ${v2.did==u.did ? "selected":""}>${v2.did }</option>
                   </c:forEach>
                   </select>  
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${u.jdescribe }">
              </div>
              <div class="layui-form-mid layui-word-aux">
                  <span class="x-red">*</span>
              </div>
