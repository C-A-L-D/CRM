        ...
        <form class="layui-form">
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.kid }" disabled="disabled">
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.kname }" required lay-verify="required">
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.kshuxin }" required lay-verify="required">
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.wangzhan }">
              </div>
          </div>
          <div class="layui-form-item">
              <label for="L_pass" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.gupiaodaima }">
              </div>
          </div>
           ...
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.shangjidanwei }">
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.suoyouzhe }" required lay-verify="required">
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.yuangongshu }">
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.hangyebianhao }" required lay-verify="required">
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.kehuleixing }" required lay-verify="required">
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.kehuzhuangtai }" required lay-verify="required">
              </div>
          </div>
          ...
          <div class="layui-form-item" style="position: absolute;left:400px;top:19px;">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.kehulaiyuan }" required lay-verify="required">
              </div>
          </div>
          ...
          <div class="layui-form-item" style="position: absolute;left:400px;top:72px;">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.fuzerenbianhao }">
              </div>
          </div>
          ...
          <div class="layui-form-item" style="position: absolute;left:400px;top:125px;">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.gudingdianhua }" required lay-verify="required">
              </div>
          </div>
          ...
          <div class="layui-form-item" style="position: absolute;left:400px;top:178px;">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.yidongdianhua }" required lay-verify="required">
              </div>
          </div>
          ...
          <div class="layui-form-item" style="position: absolute;left:400px;top:231px;">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.kehuchuangzhen }">
              </div>
          </div>
          ...
          <div class="layui-form-item" style="position: absolute;left:400px;top:284px;">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.kaihuyinhang }">
              </div>
          </div>
          ...
          <div class="layui-form-item" style="position: absolute;left:400px;top:337px;">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.yinhangzhanghu }">
              </div>
          </div>
          ...
          <div class="layui-form-item" style="position: absolute;left:400px;top:389px;">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.xiacilianxishijian }" required lay-verify="required">
              </div>
          </div>
          ...
          <div class="layui-form-item" style="position: absolute;left:400px;top:442px;">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.dianziyoujian }">
              </div>
          </div>
          ...
          <div class="layui-form-item" style="position: absolute;left:400px;top:495px;">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.sicbianma }">
              </div>
          </div>
          ...
          <div class="layui-form-item" style="position: absolute;left:400px;top:548px;">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.zhifufangshi }" required lay-verify="required">
              </div>
          </div>
          ...
          <div class="layui-form-item" style="position: absolute;left:800px;top:19px;">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.shifouyouxiao }" required lay-verify="required">
              </div>
          </div>
          ...
          <div class="layui-form-item" style="position: absolute;left:800px;top:72px;">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.xiangxidizhi }">
              </div>
          </div>
          ...
          <div class="layui-form-item" style="position: absolute;left:800px;top:125px;">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.beizhuxinxi }">
              </div>
          </div>
          ...
          <div class="layui-form-item" style="position: absolute;left:800px;top:178px;">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${khuk.gid }" required lay-verify="required">
              </div>
          </div>
