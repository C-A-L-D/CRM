      ...
      <div class="layui-card-body" style="padding: 15px;">
        <form class="layui-form" action="" method="post" lay-filter="component-form-group">        
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                <input type="text" name="rname" value="" autocomplete="on" class="layui-input">
              </div>
            </div>
          </div>
           ...
           <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="text" name="rdescribe" value="" autocomplete="on" placeholder="请输入角色描述信息" class="layui-input">
            </div>
          </div>
