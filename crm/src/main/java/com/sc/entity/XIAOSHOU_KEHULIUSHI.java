...
public class XIAOSHOU_KEHULIUSHI implements Serializable {
    private Long ksid;
    ...
    public XIAOSHOU_KEHULIUSHI(Long ksid, Long kid, String caozuorenyuanbianhao, String chulifangshi, String chulicuoshi, String shifouliushi, Long gid, Date lasttime) {
        this.ksid = ksid;
        this.kid = kid;
