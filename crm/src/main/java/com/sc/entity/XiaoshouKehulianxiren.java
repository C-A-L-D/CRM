...
public class XiaoshouKehulianxiren implements Serializable {
    private Long lid;
    ...
    public XiaoshouKehulianxiren(Long lid, Long kid, String lianxirenxingming, String yingwenming, String zhiwu, String bumen, String shouji, String bangongdianhua, String dianziyoujian, String dizhi, String beizhuxinxi, Long gid, Date lasttime) {
        this.lid = lid;
        this.kid = kid;
	...
	public String toString() {
		return "XiaoshouKehulianxiren [lid=" + lid + ", kid=" + kid + ", lianxirenxingming=" + lianxirenxingming
				+ ", yingwenming=" + yingwenming + ", zhiwu=" + zhiwu + ", bumen=" + bumen + ", shouji=" + shouji
				+ ", bangongdianhua=" + bangongdianhua + ", dianziyoujian=" + dianziyoujian + ", dizhi=" + dizhi
				+ ", beizhuxinxi=" + beizhuxinxi + ", gid=" + gid + ", lasttime=" + lasttime + "]";
	}
